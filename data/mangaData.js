const mangaData = [
  ...
  },
  {
    ...
    price: 11.99,
    description:
      "One day, a four-year-old boy came to a sudden realization: the world is not fair. Eighty percent of the world's population wield special abilities, known as 'quirks,' which have given many the power to make their childhood dreams of becoming a superhero a reality.\n\nUnfortunately, Izuku Midoriya was one of the few born without a quirk, suffering from discrimination because of it. \n\nYet, he refuses to give up on his dream of becoming a hero; determined to do the impossible, Izuku sets his sights on the elite hero training academy, UA High.However, everything changes after a chance meeting with the number one hero and Izuku's idol, All Might. \n\nDiscovering that his dream is not a dead end, the powerless boy undergoes special training, working harder than ever before. Eventually, this leads to him inheriting All Might's power, and with his newfound abilities, gets into his school of choice, beginning his grueling journey to become the successor of the best hero on the planet.",
    rate: 4,
    category: "shonen",
  },
  {
  ...
  },
  {
    ...
    price: 9.99,
    description:
      "Despite being a talented artist, middle school student Moritaka Mashiro is unsure about his future, accepting that he will simply lead a normal life. After seeing one of Mashiro's drawings in class, Akito Takagi—an aspiring writer—insists that they write a manga together. \n\nBut Mashiro is hesitant—his uncle, a mangaka, had died from overworking just a few years prior. However, when Mashiro hears that his crush, Miho Azuki, aims to be a voice actress, he becomes determined to create a manga that can be adapted into an anime for her to star in. Reciprocating Mashiro's feelings, she agrees to get married once they have both achieved their dreams.\n\nBakuman. chronicles Mashiro and Takagi's successes and struggles in their attempts to be serialized in Weekly Shounen Jump and become famous mangakas. Will their gamble pay off, or will they join the countless number of failures?",
    rate: 4.7,
    category: "shonen",
  },
  {
  ...
  },
  {
    ...
    price: 100.0,
    description:
      "Gol D. Roger, a man referred to as the 'King of the Pirates,' is set to be executed by the World Government. \n\nBut just before his demise, he confirms the existence of a great treasure, One Piece, located somewhere within the vast ocean known as the Grand Line. Announcing that One Piece can be claimed by anyone worthy enough to reach it, the King of the Pirates is executed and the Great Age of Pirates begins.Twenty-two years later, a young man by the name of Monkey D. Luffy is ready to embark on his own adventure, searching for One Piece and striving to become the new King of the Pirates. \n\nArmed with just a straw hat, a small boat, and an elastic body, he sets out on a fantastic journey to gather his own crew and a worthy ship that will take them across the Grand Line to claim the greatest status on the high seas.",
    rate: 5,
    category: "shonen",
  },
  {
  ...
  },
  {
    ...
    price: 9.99,
    description:
      "In 16th-century Japan, Shinmen Takezou is a wild, rough young man, in both his appearance and his actions. His aggressive nature has won him the collective reproach and fear of his village, leading him and his best friend, Matahachi Honiden, to run away in search of something grander than provincial life. \n\nThe pair enlist in the Toyotomi army, yearning for glory—but when the Toyotomi suffer a crushing defeat at the hands of the Tokugawa Clan at the Battle of Sekigahara, the friends barely make it out alive.After the two are separated, Shinmen returns home on a self-appointed mission to notify the Hon'iden family of Matahachi's survival. \n\nHe instead finds himself a wanted criminal, framed for his friend's supposed murder based on his history of violence. Upon being captured, he is strung up on a tree and left to die. An itinerant monk, the distinguished Takuan Soho, takes pity on the 'devil child,' secretly freeing Shinmen and christening him with a new name to avoid pursuit by the authorities: Musashi Miyamoto.\n\nVagabond is the fictitious retelling of the life of one of Japan's most renowned swordsmen, the 'Sword Saint' Musashi Miyamoto—his rise from a swordsman with no desire other than to become 'Invincible Under the Heavens' to an enlightened warrior who slowly learns of the importance of close friends, self-reflection, and life itself.",
    rate: 4,
    category: "seinen",
  },
  {
  ...
  },
  {
    ...
    price: 9.99,
    description:
      "Seventeen years ago, mysterious immortal soldiers known as 'divine warriors' appeared on the battlefields of Africa. These life forms later became known as 'Ajin,' or demi-humans, and were considered to be one of the greatest discoveries of mankind. \n\nThe government declared their existence to be compatible with humans; however, it is rumored that they instead offer bounties for captured Ajin to secretly perform inhumane experiments on these rare beings.\n\nKei Nagai, an apathetic high school student, is studying to become a doctor and only wishes to live a normal life. However, this simple dream is shattered after he suddenly gets into a deadly traffic accident. Reviving at the scene, he is immediately labeled as an Ajin by bounty-hungry witnesses. \n\nUnable to understand his immortality or prove his innocence, he starts to live his life on the run and fights for survival. He barely escapes the government's reach when a group of anarchistic Ajin contacts Kei, asking him to join their forces to retaliate against the government. But who is Kei's real enemy, and which side will he take when it comes down to humans versus Ajin?",
    rate: 3,
    category: "seinen",
  },
  {
  ...
  },
  {
    ...
    price: 9.99,
    description:
      "Hayakawa Yui is totally a unmotivated, lazy girl who loves sleeping and eating. She's 16 but looks like a boy from elementary school; her one and only talent is to run really fast. \n\nAfter accidentally switching on the time machine which her younger brother made she travels to the Sengoku period, where luckily she joins retreating foot soldiers using the name Yuinosuke. Then she eats some amanitas and meets the man of her dreams.",
    rate: 3.2,
    category: "josei",
  },
  {
